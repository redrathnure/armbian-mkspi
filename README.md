...
2. Some bugs may appear from time to time. Especially it related to edge builds (based on non stable 6.x kernel). Please check [concrete release page](https://github.com/redrathnure/armbian-mkspi/releases) for more details.
